...
const BottomControls = ({ category }: { category: ValidCategory }) => {
  ...
  return (
    <div className="fixed md:hidden bottom-0 left-0 right-0 bg-primary text-primary-foreground border-t border-primary px-6 py-3 shadow-md flex items-center justify-between">
